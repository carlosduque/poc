...
--
CREATE USER world WITH PASSWORD 'dlrow';
CREATE DATABASE world OWNER world;
...
CREATE TABLE country (
  ...
  surface_area float(2) NOT NULL default '0.00',
  independence_year smallint default NULL,
  population integer NOT NULL default '0',
  life_expectancy float(1) default NULL,
...
CREATE TABLE country_language (
  ...
  is_official boolean,
  percentage float(1) NOT NULL default '0.0',
