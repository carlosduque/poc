...
"""
Este programa se encarga de hacer respaldos.
El usuario puede determinar el directorio origen y destino desde la linea de comando
o en la configuracion interior, la calendarizacion se deja a programas externos como 'cron'.
