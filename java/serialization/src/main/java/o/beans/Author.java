...
public class Author extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    throws java.io.IOException
  {
    ...
    out.writeLong(this.dob);

    long size0 = this.books.size();
    out.writeArrayStart();
    out.setItemCount(size0);
    long actualSize0 = 0;
    for (o.beans.Book e0: this.books) {
      actualSize0++;
      out.startItem();
      e0.customEncode(out);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.List<o.beans.Book> a0 = this.books;
      if (a0 == null) {
        a0 = new SpecificData.Array<o.beans.Book>((int)size0, SCHEMA$.getField("books").schema());
        this.books = a0;
      } else a0.clear();
      SpecificData.Array<o.beans.Book> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<o.beans.Book>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          o.beans.Book e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
            e0 = new o.beans.Book();
          }
          e0.customDecode(in);
